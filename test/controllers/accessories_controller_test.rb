...
class AccessoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create accessory" do
    assert_difference('Accessory.count') do
      post accessories_url, params: { accessory: { accessory_name: @accessory.accessory_name, cost: @accessory.cost, description: @accessory.description, stock: @accessory.stock } }
    end
  ...
  test "should update accessory" do
    patch accessory_url(@accessory), params: { accessory: { accessory_name: @accessory.accessory_name, cost: @accessory.cost, description: @accessory.description, stock: @accessory.stock } }
